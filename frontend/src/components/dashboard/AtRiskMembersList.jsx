...
export function AtRiskMembersList({ members }) {
  const defaultMembers = [
    { id: 'm1', name: 'Amina Kimaro', zone: 'Kisauni', programs: ['Mentorship'], lastSeen: '45 days ago', eventCount: 2 },
    { id: 'm2', name: 'Juma Ali', zone: 'Mvita', programs: ['Coding Bootcamp'], lastSeen: '60 days ago', eventCount: 1 },
    { id: 'm3', name: 'Fatma Said', zone: 'Likoni', programs: ['Arts & Culture'], lastSeen: '35 days ago', eventCount: 3 },
    { id: 'm4', name: 'Kibwana Omar', zone: 'Nyali', programs: ['Tech Hub'], lastSeen: '90 days ago', eventCount: 0 },
  ];
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full">
      <div className="p-5 border-b border-gray-100 flex items-center justify-between">
        ...
        <span className="bg-amber-100 text-amber-800 text-xs font-bold px-2 py-1 rounded-md">{displayMembers.length} Flagged</span>
      </div>
      
      <div className="divide-y divide-gray-100 flex-1 overflow-y-auto">
        {displayMembers.map((member) => {
          const engagement = getEngagementLevel(member.eventCount);
          return (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                    <span className="px-2 py-0.5 bg-gray-100 rounded text-gray-600">{member.zone}</span>
                    <span>•</span>
                    <span>Seen {member.lastSeen}</span>
                  </div>
                </div>
              </div>
